...
public class SceneMgr
{
    ...
    public delegate void OnSwitchingScene (SceneName type);
    ...
    /// 存储当前已经实例化的场景
    /// </summary>
    public Dictionary<SceneName, SceneBase> scenes;
    /// <summary>
    /// 当前场景
    /// </summary>
    ...
    /// 主场景
    /// </summary>
    private const SceneName mainSceneType = SceneName. Scene_Main;

    private SceneMgr ()
    {
        scenes = new Dictionary<SceneName, SceneBase>();
    ...
    public void SwitchingScene (SceneName sceneType, params object [] sceneArgs)
    {
        if (current != null)
        {
    ...
    /// <param name="sceneType"></param>
    /// <param name="sceneArgs">场景参数</param>
    private void ShowScene (SceneName sceneType, params object [] sceneArgs)
    {
        ...
        else
        {
            ...
            current = go. AddComponent(mType) as SceneBase; //sceneType.tostring等于该场景的classname
    ...
    {
        internal SceneName sceneType;
        internal object [] sceneArgs;

        internal SwitchRecorder (SceneName sceneType, params object [] sceneArgs)
        {
